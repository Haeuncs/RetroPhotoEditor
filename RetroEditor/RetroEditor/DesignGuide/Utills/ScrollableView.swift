...
struct ScrollableView<Content: View>: UIViewControllerRepresentable, Equatable {
    ...
    final class Coordinator: NSObject, UIScrollViewDelegate {
        ...
        var isDrag: Binding<Bool>

        // MARK: - Init
        init(_ scrollView: UIScrollView, offset: Binding<CGPoint>, isDrag: Binding<Bool>) {
        ...
        func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
            isDrag.wrappedValue = true
        }

        func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
            isDrag.wrappedValue = false
        }
    ...
    var isDrag: Binding<Bool>
    var delegate: ScrollableViewDelegate?
    ...
    init(
        ...
        delegate: ScrollableViewDelegate? = nil,
        isDrag: Binding<Bool>,
    ...
    func makeCoordinator() -> Coordinator {
        Coordinator(self.scrollViewController.scrollView, offset: self.offset, isDrag: self.isDrag)
    }
...
final class UIScrollViewController<Content: View> : UIViewController, ObservableObject {
    ...
    init(
        ...
        delegate: ScrollableViewDelegate?
    ) {
        self.offset                                 = offset
    ...
    func updateContent(_ content: () -> Content) {
        ...
        delegate?.updateContentSize(size: contentSize)
